...
> = {
  italian: {
    ...
    highlights: [
      ...
      },
      {
        ...
        text: "Градината и камината правят ресторанта топъл и спокоен след разходка из София."
      }
    ],
    checklist: [
  ...
  spanish: {
    ...
    lead:
      "Приветлив ресторант близо до центъра на София с тайна градина, бавно печено BBQ, вегетариански ястия и екип, който говори английски.",
    highlights: [
      {
